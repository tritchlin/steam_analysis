...
from layouts import display_bargraph, display_choropleth
from app import app
...
def render_tab_content(active_tab):
    ...
    if active_tab is not None:
        if active_tab == "graph1":
            return dcc.Graph(figure=display_choropleth, id='choropleth')
        elif active_tab == "graph2":
            return dcc.Graph(figure=display_bargraph, id='bar')
